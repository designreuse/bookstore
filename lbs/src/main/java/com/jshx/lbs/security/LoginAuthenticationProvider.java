...
public class LoginAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    protected void additionalAuthenticationChecks(UserDetails userDetails,
        ...
        if (userDetails.getPassword()==null || !userDetails.getPassword().equals(md5.getMD5ofStr(presentedPassword).toLowerCase())) {
    ...
    protected void doAfterPropertiesSet() throws Exception {
        Assert.notNull(this.loginUserDetailsService, "A UserDetailsService must be set");
    }
    ...
    protected final UserDetails retrieveUser(String username,
        ...
        try {
            loadedUser = this.getLoginUserDetailsService().loadUserByUsername(username,companyId);
        }
