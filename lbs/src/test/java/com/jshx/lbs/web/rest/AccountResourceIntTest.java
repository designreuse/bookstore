...
import com.jshx.lbs.domain.Authority;
import com.jshx.lbs.domain.User;
import com.jshx.lbs.repository.AuthorityRepository;
import com.jshx.lbs.repository.SysUserRepository;
import com.jshx.lbs.repository.UserRepository;
import com.jshx.lbs.security.AuthoritiesConstants;
...
public class AccountResourceIntTest {
    ...
    public void setup() {
        ...
        AccountResource accountResource =
            new AccountResource(userRepository, userService, mockMailService,sysUserRepository);

        AccountResource accountUserMockResource =
            new AccountResource(userRepository, mockUserService, mockMailService,sysUserRepository);
    ...
    public void testSaveInvalidEmail() throws Exception {
        ...
        Assertions.assertThat(userRepository.findOneByEmail("invalid email")).isNotPresent();
    }
